...
<div v-if="!codeSent">
    <div class="field is-font-family-montserrat">
        ...
        <p class="help for-label font-weight-600">Enter your email address and we will resend your booking reservation code.</p>
        <div class="control">
...
export default {
    ...
    methods: {
        sendCode() {
            this.isLoading = true;
            let request = this.$http.post(`/groups/${this.group}/resend-code`, this.sendCodeData)
                .then((response) => {
                    this.codeSent = true;
                })
                .catch(error => {
