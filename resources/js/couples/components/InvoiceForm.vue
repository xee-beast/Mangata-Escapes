<template>
<div>
    <button @click="show = true" class="button is-medium is-fat is-rounded is-outlined is-black">VIEW YOUR INVOICE</button>
    <modal :is-active="show" @hide="close">
        <div class="form-container">
            <div class="form-header">
                <div class="form-title">{{ group.name }} - View Invoice</div>
...
export default {
    ...
    methods: {
        ...
        next(sendEmail) {
            ...
            this.message = null;
            this.isLoading = true;
            let request = this.$http.post(`/groups/${this.group.id}/invoice`, this.invoice)
                .then(() => {
