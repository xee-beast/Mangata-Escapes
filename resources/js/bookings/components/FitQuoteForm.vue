<template>
    <div>
        <button @click="show = true" class="button is-medium is-rounded is-outlined is-black custom-booking-button-class">ACCEPT QUOTE</button>
        <modal :is-active="show" @hide="close">
            <div class="form-container">
                <div class="form-header">
                    <div class="form-title">Accept Quote</div>
                </div>
                <div class="form-content">
                    ...
                    <template v-else>
                        ...
                        <template v-else-if="step == 2">
                            ...
                            <form ref="form" :action="`/quote-invoice`" target="_blank" method="POST">
    ...
    export default {
        ...
        methods: {
            ...
            next() {
                ...
                let request = this.$http.post(`/individual-bookings/accept-fit-quote/${this.step}`, this.clientCredentials)
                    .then(response => {
                        this.step++;
                    }).catch (error => {
