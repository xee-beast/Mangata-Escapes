<template>
<modal @hide="close" title="Delete Booking" :is-active="true">
	<p>
		Are you sure you want to delete this booking?
		<br><br>
		This will entirely remove the booking including the following guests:
	</p>
...
export default {
	...
	methods: {
		confirm() {
			...
			let request = this.$http.delete('/groups/' + this.$route.params.group + '/bookings/' + this.booking.id + '/force')
				.then(response => {
					this.$emit('forceDeleted', this.booking);
