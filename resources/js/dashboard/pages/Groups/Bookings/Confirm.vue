...
<modal @hide="close" title="Confirm Booking" :is-active="true">
	...
	<ul style="list-style: inside disc;">
		<li>The booking has been confirmed with {{ provider.name }}.</li>
		<li>All the information matches the information at {{ provider.name }}.</li>
	</ul>
	<br>
	<p>
	...
	methods: {
		confirm() {
			...
			let request = this.$http.patch(
					'/groups/' + this.$route.params.group + '/bookings/' + this.booking.id + '/confirm',
