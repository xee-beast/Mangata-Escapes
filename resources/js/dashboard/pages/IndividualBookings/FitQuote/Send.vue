    ...
    export default {
        ...
        methods: {
            confirm() {
                ...
                let request = this.$http.post('/individual-bookings/' + this.booking.id + '/send-fit-quote', payload)
                    .then(() => {
            ...
            cancel(client) {
                ...
                let request = this.$http.post('/individual-bookings/' + this.booking.id + '/cancel-fit-quote', {fitQuoteId: client.pendingFitQuote.id})
                    .then(() => {
