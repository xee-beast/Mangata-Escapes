    ...
    public function rules()
    {
        ...
        if ($this->route('step') > 1) {
            ...
            $validation = array_merge($validation, [
                ...
                'confirmation.signature' => ['required', function ($attribute, $value, $fail) use ($bookingClient) { if (strtolower($value) !== strtolower($bookingClient->name)) { $fail('You must type your full name.'); } }]
            ]);
