...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Barefoot Bridal'),
    ...
    */
    ...
    'auth_url' => env('APP_AUTH_URL'),

    'dashboard_url' => env('APP_DASHBOARD_URL'),

    'group_url' => env('APP_GROUP_URL'),

    'bookings_url' => env('APP_BOOKINGS_URL'),
    ...
    */
    ...
    'aliases' => [
        ...
        'PDF' => (env('PDF_ENGINE', 'dompdf') === 'snappy')
